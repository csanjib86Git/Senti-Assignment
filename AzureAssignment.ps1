...
$templateFilePath =  Read-Host "enter the location for template file (for example C:\temp1\template.json)"
$ParameterFilePath = Read-Host "enter the location of the rule file name (for example C:\temp1\rule.json)"
